 ...
 <div class="container mt-4">
            <div class="card border-info">
                <div class="card-header bg-info text-white">
                    <a class="btn btn-light" href="AgregarPlatillos.htm">Nuevo Registro</a>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>${dato.Stock}</td>
                                  <td>${dato.Calidad}</td>
                                <td>
                                    <a href="EditarPlato.htm?idPlato=${dato.idPlato}" class="btn btn-warning">Editar</a>
                                    <a href="Eliminar.htm?idPlato=${dato.idPlato}" class="btn btn-danger">Eliminar</a>
                                </td>
                            </tr>
                            </c:forEach>
                        </tbody>
